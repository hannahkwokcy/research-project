...
class LRFinder(tf.keras.callbacks.Callback):
    def __init__(self, min_lr, max_lr, num_epochs, name="DenseNet121"):
        super().__init__()
        self.min_lr = min_lr
        self.max_lr = max_lr
    ...
    def get_best_lr(self):
        ...
        # Skip the first 10% of the data to avoid "false starts"
...
lr_finder_p1.plot_lr_loss("densenet_phase1_lr.png")
...
# Freeze layers up to the last dense block for DenseNet121
...
lr_finder_p2.plot_lr_loss("densenet_phase2_lr.png")
